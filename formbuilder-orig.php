...
$filhtml = rand();
$abc = UPLOAD_DIR .$filhtml.'.html';
file_put_contents($abc,$content3);

echo $abc. ' created';


$form = 'https://www.formrecorder.com/'.$abc; 
...
<div class="container-fluid">
   ...
   <div class="col-md-12 shadow p-4 mb-4 border border-primary" style="background-color:pink">
	 ...
	 <h6><a href="'.$form.'"target=_blank><h6>Customized Google form:</h6>
...
define('UPLOAD_DIR', 'forms/');
$filhtml1 = rand();
$abc1 = UPLOAD_DIR .$filhtml1.'.html';
file_put_contents($abc1,$content4);

$form1 = 'https://www.formrecorder.com/'.$abc1;  
...
$mail->Body     = 'Hi! '.$yourname.'following is your customized Google form'.$form;
